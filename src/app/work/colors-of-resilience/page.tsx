	...
	return (
		<div className="container mx-auto md:w-1/2 mt-12 relative p-5">
			...
			<p className="text-primary-color text-sm mt-6">
				This is an online art marketplace. I used figma to create the design for
				the page. I used Next.js with Typescript and Tailwind to style and
				animate the page. For the backend I used PostgreSQL database and Prisma
				...
				applications data. To streamline database operations and ensure
				efficient querying, I utilized Prisma as an Object-Relational Mapping
				(ORM) tool. Prismas type-safe database client and intuitive API
